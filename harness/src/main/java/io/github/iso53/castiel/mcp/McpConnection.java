...
/**
 * Owns the LangChain4j MCP client for one server. The first operation performs
 * the MCP handshake; afterwards the tool list is kept for the chat loop.
 */
public class McpConnection implements AutoCloseable {
	...
	/** Performs the handshake and fetches the tool list from the server. */
